        ...
        <nav className="flex items-center justify-between w-full">
          ...
          <div className="hidden lg:flex lg:justify-end">
            {!isLogin ? (
                          ...
                          <button onClick={() => handleLoginClick('logout')}>
                              로그아웃
                          </button>
                        )
            }
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full px-6 py-3 overflow-y-auto bg-white sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            <div className="flow-root mt-6">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  {!isLogin ? (
                            <button className="block w-full px-3 py-2 -mx-3 text-base leading-7 text-left text-gray-900 rounded-lg fontBold hover:bg-indigo-900 hover:text-white" 
